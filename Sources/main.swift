...
struct XCSift: ParsableCommand {
    static let configuration = CommandConfiguration(
        ...
        usage:
            "xcodebuild [options] 2>&1 | xcsift [--format|-f json|toon|github-actions] [--toon-delimiter comma|tab|pipe] [--toon-length-marker none|hash] [--warnings|-w] [--Werror|-W] [--quiet|-q] [--coverage|-c] [--executable|-e] [--version|-v] [--help|-h]",
        discussion: """
